...
%define __nginxconfigdir	/etc/nginx/conf.d/
...
%{__mkdir} -p %{buildroot}/%{__nginxconfigdir}
%{__install} -pD -m 644 nginx.conf %{buildroot}/%{__nginxconfigdir}/%{name}.conf
